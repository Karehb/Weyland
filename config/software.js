function camara(args) {
    if (args.length === 0) {
        return [
            ...
            `Actualmente tienes acceso a las siguientes camaras: ${Object.keys(CAMERAS).join(" ")}`
        ];
    }
    ...
    return <img src='config/camBroken.jpg' class='glitch'>; // Opcionalmente, puedes retornar algo más útil aquí, o simplemente null.
}
